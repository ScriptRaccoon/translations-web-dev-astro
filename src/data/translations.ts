...
export const translations: translation[] = [
	...
	["if else statement", "Bedingte Verzweigung", 2],
	["switch case statement", "Fallunterscheidung", 2],
	...
	["endpoint", "Endpunkt", 2],
	["computer", "Rechner / Rechenmaschine", 2],
	...
	["literal", "Literal", 2],
	["static", "statisch", 3],
	["asset", "Projektelement / Medieninhalt", 1],
	...
	["integrated development environment / IDE", "Integrierte Entwicklungsumgebung", 3],
	...
	["text flow", "Textlaufrichtung", 3],
	["open source", "Quelloffen", 2],
	["port", "Netzwerkdienstnummer", 1],
	["host", "Netzwerkgerät", 1],
	["hostname", "Netzwerkgerätename", 1],
	["memory", "Speicher", 2],
	["address", "Addresse", 3],
	["offscreen", "außerhalb der Zeichenfläche", 1],
	["offset", "Versatz", 2],
	["thread", "Ausführungsreihenfolge / Ausführungsstrang", 2],
	["main thread", "Primärer Ausführungsstrang", 1],
	["worker", "Ausführungseinheit", 2],
	["process", "Prozess", 3],
	["translate", "verschieben", 3],
	["scale", "skalieren", 3],
	["rotate", "drehen", 3],
	["license", "Lizens", 2],
	["commit", "einchecken", 2],
	["branch", "Verzweigung", 2],
	["remote", "auf Distanz", 1],
	["pull request", "Übernahme-Anfrage", 1],
	["goto statement", "Sprungbefehl", 2],
	["computing", "Prozessverarbeitung", 2],
	["batch processing", "Stapelverarbeitung", 2],
	["zip", "zusammenfügen", 2],
	["archive", "Archiv", 2],
	["compress", "komprimieren", 3],
	["backup", "Sicherung", 2],
];

export const numberOfTranslations = translations.length;
export const numberOfMissingTranslations = translations.filter((t) => t[2] === 0).length;
